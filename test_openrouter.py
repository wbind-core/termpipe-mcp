#!/usr/bin/env python3
"""Test script for OpenRouter only - measure latency."""
...
def test_openrouter(num_calls: int = 5, timeout: int = 30):
    """Test OpenRouter latency only."""
    print(f"Testing OpenRouter only ({num_calls} calls)...\n")
